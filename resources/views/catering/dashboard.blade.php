...
<div class="container">
    ...
    <div class="d-flex flex-wrap flex-row">
        ...
        <div class="col-3">
            <a href="{{ route('dishes', $supplier->id) }}" class="d-flex shadow-lg flex-column justify-content-between align-items-start text-decoration-none p-2 border border-secondary blurred h-100">
